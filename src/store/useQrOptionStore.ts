...
export type NumericQrOptions = keyof Pick<QrOptionsType, 'width' | 'height' | 'eyeRadius' | 'logoPadding'>;

export type StringQrOptions = keyof Pick<QrOptionsType, 'qrStyle' | 'ecLevel' | 'logoPaddingStyle'>;

export interface QrOptionsStore {
  qrOptions: QrOptionsType;
  setQrOption: (_key: keyof QrOptionsType, _value: QrOptionsType[keyof QrOptionsType]) => void;
}
